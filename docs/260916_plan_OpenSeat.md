...
- **各フェーズの実装プランは `YYMMDD_plan_PhaseN.md` として別に作る。** 本計画書が「何を作るか」、フェーズ別プランが「どの順番で、どの粒度で作るか」を定める。Phase 1 は [`260917_plan_Phase1.md`](260917_plan_Phase1.md)本計画書が「何を作るか」、CLAUDE.md が「どう作るか」を定める。**本計画書が設計の唯一の出典**で、両者が食い違ったら本計画書を正とし、CLAUDE.md を直す
